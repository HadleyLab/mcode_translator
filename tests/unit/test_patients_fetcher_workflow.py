...
class TestPatientsFetcherWorkflow:
    ...
    def test_execute_single_patient_not_found(self, mock_create_generator, workflow):
        ...
        result = workflow.execute(
            archive_path="breast_cancer_10_years", patient_id="nonexistent_patient"
        )
    ...
    def test_execute_multiple_patients_success(
        ...
        result = workflow.execute(archive_path="breast_cancer_10_years", limit=2)
    ...
    def test_execute_multiple_patients_empty_archive(
        ...
        result = workflow.execute(archive_path="empty_archive", limit=5)
    ...
    def test_fetch_multiple_patients_generator_error(
        ...
        result = workflow.execute(archive_path="invalid_archive", limit=5)
    ...
    def test_save_results_creates_directory(
        self, mock_file, mock_mkdir, workflow, mock_patient_data
    ):
    ...
    def test_execute_with_limit_zero(self, mock_create_generator, workflow):
        ...
        result = workflow.execute(archive_path="breast_cancer_10_years", limit=0)
    ...
    def test_execute_limit_exceeds_available(
        ...
        result = workflow.execute(
            archive_path="small_archive", limit=10  # Request more than available
        )

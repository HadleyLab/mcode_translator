...
class TestDataFlowCoordinator:
    ...
    def test_init_with_pipeline(self, mock_pipeline):
        ...
        coordinator = DataFlowCoordinator(pipeline=mock_pipeline, config=config)
    ...
    def test_generate_flow_summary(self, sample_trial_ids):
        ...
        summary = coordinator._generate_flow_summary(
            sample_trial_ids, fetch_result, processing_result
        )
    ...
    def test_process_clinical_trials_flow_convenience(
        self, mock_create_coordinator, sample_trial_ids
    ):
        ...
        mock_coordinator.process_clinical_trials_complete_flow.assert_called_once_with(
            sample_trial_ids
        )

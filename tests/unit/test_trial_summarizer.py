...
class TestTrialSummarizer:
    ...
    def test_generate_trial_natural_language_summary_success(self, mock_create_summary, trial_summarizer, sample_trial_data):
    ...
    @patch('src.services.summarizer.McodeSummarizer.create_trial_summary')
    def test_generate_trial_natural_language_summary_exception(self, mock_create_summary, trial_summarizer, sample_trial_data):
    ...
    def test_convert_trial_mcode_to_mappings_format_complex_elements(self, trial_summarizer, sample_mcode_elements):
        ...
        assert len(result) == 6  # 1 identifier + 2 conditions + 1 intervention + 1 study type + 1 status + 1 comorbid condition
        ...
        intervention_mapping = next(m for m in result if m["mcode_element"] == "TrialMedicationInterventions")
    ...
    def test_convert_trial_mcode_to_mappings_format_exception(self, trial_summarizer):
        ...
        with patch('builtins.print'):
            ...
            problematic_elements = {
                "ProblemElement": {"nested": {"deeply": {"nested": "value"}}}
            }
    ...
    def test_format_trial_mcode_element_snomed(self, trial_summarizer):
        ...
        result = trial_summarizer.format_trial_mcode_element("CancerCondition", "http://snomed.info/sct", "C50")
    ...
    def test_format_trial_mcode_element_loinc(self, trial_summarizer):
        ...
        result = trial_summarizer.format_trial_mcode_element("LabTest", "http://loinc.org", "12345-6")
    ...
    def test_format_trial_mcode_element_cvx(self, trial_summarizer):
        ...
        result = trial_summarizer.format_trial_mcode_element("Vaccine", "http://hl7.org/fhir/sid/cvx", "207")
    ...
    def test_format_trial_mcode_element_rxnorm(self, trial_summarizer):
        ...
        result = trial_summarizer.format_trial_mcode_element("Medication", "http://www.nlm.nih.gov/research/umls/rxnorm", "123456")
    ...
    def test_format_trial_mcode_element_icd(self, trial_summarizer):
        ...
        result = trial_summarizer.format_trial_mcode_element("Diagnosis", "http://hl7.org/fhir/sid/icd-10", "C50.1")
    ...
    def test_format_trial_mcode_element_clinicaltrials_gov(self, trial_summarizer):
        ...
        result = trial_summarizer.format_trial_mcode_element("TrialIdentifier", "https://clinicaltrials.gov", "NCT12345678")
    ...
    def test_format_trial_mcode_element_generic_url(self, trial_summarizer):
        ...
        result = trial_summarizer.format_trial_mcode_element("GenericElement", "http://example.com/system/custom", "CODE123")
    ...
    def test_format_trial_mcode_element_unknown_system(self, trial_summarizer):
        ...
        result = trial_summarizer.format_trial_mcode_element("UnknownElement", "unknown-system", "UNKNOWN")
    ...
    def test_format_trial_mcode_element_case_insensitive(self, trial_summarizer):
        ...
        result = trial_summarizer.format_trial_mcode_element("TestElement", "HTTP://SNOMED.INFO/SCT", "C50")

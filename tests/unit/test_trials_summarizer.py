...
class TestTrialsSummarizerCLI:
        ...
        mock_mcode_data = [
            {
                ...
                "original_trial_data": {"protocolSection": {"identificationModule": {"nctId": "NCT12345678"}}}
            }
        ]
    ...
    def test_main_no_input_file_uses_stdin(self):
        ...
        # Mock stdin
        mock_mcode_data = {"trial_id": "NCT12345678", "McodeResults": {"mcode_mappings": []}}
        with patch("sys.stdin.read", return_value=json.dumps(mock_mcode_data)), \
             patch("src.cli.trials_summarizer.McodeCLI.setup_logging"), \
             patch("src.cli.trials_summarizer.McodeCLI.create_config"), \
             patch("src.cli.trials_summarizer.TrialsSummarizerWorkflow") as mock_workflow_class, \
    ...
    def test_extract_summaries_with_missing_data(self):
        ...
        mock_data = [
            ...
            {"protocolSection": {"identificationModule": {"nctId": "NCT12345678"}}},  # Missing McodeResults
            {}  # Empty data
        ]

...
class TestApiIntegration:
    ...
    def test_search_trials_with_pagination(self, mock_get):
        ...
        mock_get.assert_called_once_with(
            ...
            params={"format": "json", "query.term": "breast cancer", "pageSize": 100, "pageToken": "token123"},
            timeout=30
        )
    ...
    def test_concurrent_api_calls(self, mock_get):
        ...
        for i in range(3):
            ...
            mock_resp.json.return_value = {"protocolSection": {"identificationModule": {"nctId": f"NCT{i}"}}}

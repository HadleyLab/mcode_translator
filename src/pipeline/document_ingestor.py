...
class DocumentIngestor(Loggable):
    ...
    def _extract_module_content(self, module_data: Dict[str, Any], module_name: str) -> str:
        ...
        if module_name == 'eligibilityModule':
            ...
            for intervention in interventions:
                content_parts.append(f"Intervention: {intervention.get('name', '')} - {intervention.get('type', '')}")
    ...
    def create_source_reference(self, section: DocumentSection, text_fragment: str, 

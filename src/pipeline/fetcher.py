...
def _search_trials(
    search_expr: str, fields_str: str, max_results: int, page_token: str
):
    """
...
def get_full_study(nct_id: str):
    ...
    """
    # Generate cache key
    cache_key_data = {"function": "get_full_study", "nct_id": nct_id}
...
def process_eligibility_criteria_with_mcode(
    criteria_text, prompt_name="direct_mcode", model_name=None
):
    """
    ...
    try:
        ...
        mock_trial_data = {
            "protocolSection": {
                ...
                "eligibilityModule": {"eligibilityCriteria": criteria_text},
            }
        }
        ...
        logger.info(
            f"mCODE processing completed - mapped {len(result.mcode_mappings)} mCODE elements"
        )

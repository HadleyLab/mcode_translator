...
class McodePipeline:
    ...
    def __init__(
        ...
        # LLMService will be created in async context for proper cleanup
    ...
    async def process(self, trial_data: Dict[str, Any]) -> PipelineResult:
        ...
        """
        # Create LLMService with async context manager for proper cleanup
            ...
            try:
                ...
                for section in sections:
                    if section.content and section.content.strip():
                        elements = await llm_service.map_to_mcode(section.content)

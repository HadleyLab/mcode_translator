...
"""
    ...
    def _extract_combinations_data(self, biological_content: str) -> Dict[str, Dict[str, Any]]:
    ...
    def _extract_rater_performance(self, inter_rater_content: str) -> Dict[str, Dict[str, Any]]:

"""mCODE Translation Optimizer - Simple Refreshable Implementation"""
...
class McodeOptimizerSimple:
    """Simple mCODE optimizer using @ui.refreshable with manual refresh"""
    ...
    def setup_ui(self):
        """Setup main UI"""
        ui.label('🎯 mCODE Optimization - Simple Refreshable').classes('text-3xl font-bold text-center mb-6')
    ...
    @ui.refreshable
    def show_stats(self):
        """Display current statistics - refreshable"""
        with ui.card().classes('w-full mb-4'):
    ...
    def show_results(self):
        """Display results table - refreshable"""
    ...
    def refresh_ui(self):
        ...
        self.show_stats.refresh()
        self.show_results.refresh()
    ...
    async def _process_single_task(self, task):
        ...
        try:
            ...
            self.refresh_ui()  # Refresh UI to show processing status
            ...
            # Refresh UI after task completion
            self.refresh_ui()
...
def main():
    ...
    optimizer = McodeOptimizerSimple()
    optimizer.setup_ui()


if __name__ in {"__main__", "__mp_main__"}:
    main()
    ui.run(title="mCODE Optimizer - Simple", port=8081)
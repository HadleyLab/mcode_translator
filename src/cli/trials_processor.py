#!/usr/bin/env python3
"""
Trials Processor CLI - Process clinical trials with mCODE mapping.
"""
...
def main(args):
    """
    CLI main function for trials processor.
    ...
    try:
        ...
        workflow = TrialsProcessor(config)
        ...
        if result.success:
            ...
            if result.data:
                print(f"Total trials processed: {len(result.data)}")

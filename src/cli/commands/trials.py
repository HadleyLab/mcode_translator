...
def trials_pipeline(
    ...
    engine: str = typer.Option("llm", help="Processing engine: 'regex', 'llm', or 'ensemble'"),
...
def _make_trial_json_serializable(trial):
    ...
    from shared.models import McodeElement, ProcessingMetadata, TokenUsage, ValidationResult
